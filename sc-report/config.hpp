...
struct Config {
    ...
    sc_core::sc_severity max_severity       = sc_core::SC_FATAL;
...
inline void set_max_severity(sc_core::sc_severity s)  { std::lock_guard<std::mutex> g(cfg_mutex); cfg.max_severity = s; }
